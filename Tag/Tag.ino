...
// #define DEVICE_ADDRESS "ec:62:60:e2:7c:34"
...
//   Serial.println("Attached New Range");
...
//     Serial.println("I ran as anchor 1");
//     // Update the display
...
void setup()
{
    ...
    DW1000Ranging.startAsTag("ec:62:60:e2:7c:34", DW1000.MODE_LONGDATA_RANGE_LOWPOWER);
}
