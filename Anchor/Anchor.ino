...
// #define DEVICE_ADDRESS "10:97:bd:51:a1:d8"
...
//   // Serial.println(currentShortAddress[1]);
...
#define ANCHOR_ADD "10:97:bd:51:a1:d8"
...
void setup()
{
    ...
    DW1000Ranging.startAsAnchor(ANCHOR_ADD, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, true);
    Serial.println("I ran 6");
